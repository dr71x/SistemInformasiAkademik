                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                     <a href="{{ url('guru/materi/index/'.$item->kelas_id) }}" class="btn btn-rounded btn-primary mb-3"><span
                                        class="btn-icon-left text-primary"><i class="fas fa-plus"></i></span> Lihat Materi</button></a>
                                    </center>
                                </td>
                            </tr>
                            @empty
