...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4>Validasi NILAI SISWA </h4></div>
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><h5>{{ $item->nama_kelas}}</h5></td>
                                <td>
                                    <center>
                                     <a href="{{ route('validasi-semester',['kelas_id' => $item->id]) }}" class="btn btn-rounded btn-success mb-3"><span
