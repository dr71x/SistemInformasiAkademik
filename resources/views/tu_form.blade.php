                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::text('nama',null,['class' => 'form-control','placeholder'=>'NAMA Staff TU']) }}
                                    <span class="text-danger">{{ $errors->first('nama') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::select('status',['GTY'=>'Pegawai tetap','Honor'=>'Honor'],null,['class' => 'form-control','placeholder'=>'Status']) }}
