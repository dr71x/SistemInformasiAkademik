...
<div class="row">
    @if ($jam > '05:30' && $jam < '12:00')
            ...
            <div class="card border-right">
                    <div class="card-body">
                        <h2 > Selamat Pagi {{ \Auth::guard('siswa')->user()->nama }} <img src="https://img.icons8.com/office/16/000000/sunrise--v2.gif" height="100" width="100" align="right"/></h2>
                    </div>
            </div>
     </div>
...
<div class="col-md-12">
    <div class="card border-right">
            <div class="card-body">
                <h2 > Selamat Siang {{ \Auth::guard('siswa')->user()->nama }} <img src="https://img.icons8.com/office/16/000000/sun--v2.gif" width="100" height="100" align="right"/></h2>
            </div>
    </div>
</div>
...
<div class="col-md-12">
    <div class="card border-right">
            <div class="card-body">
                <h2 > Selamat Sore {{ \Auth::guard('siswa')->user()->nama }} <img src="https://img.icons8.com/office/16/000000/sunset--v2.gif" height="100" width="100" align="right"/></h2>
            </div>
    </div>
</div>
@else
<div class="col-md-12">
    <div class="card border-right">
            <div class="card-body">
                <h2 > Selamat Malam {{ \Auth::guard('siswa')->user()->nama }} <img src="https://img.icons8.com/plasticine/100/000000/fog-night--v2.gif" height="100" width="100" align="right"/></h2>
            </div>
    </div>
</div>
@endif
            ...
            <div class="card-body">
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-right">
                        <p class="fs-18 text-white mb-2">Jadwal Pelajaran</p>
                        <span class="fs-48 text-white font-w600">{{ $jadwal }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card bg-info">
            <div class="card-body">
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-right">
                        <p class="fs-18 text-white mb-2">Jumlah Mata Pelajaran</p>
                        <span class="fs-48 text-white font-w600">{{ $mapel }}</span>
                    </div>
                </div>
            </div>
        </div>
